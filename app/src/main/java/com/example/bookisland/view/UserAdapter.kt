package com.example.bookisland.view
...
class UserAdapter(val c:Context,val userList:ArrayList<UserData>):RecyclerView.Adapter<UserAdapter.UserViewHolder>() {
    ...
    inner class UserViewHolder(val v: View) : RecyclerView.ViewHolder(v) {
        ...
        private fun popupMenus(v: View) {
            ...
            popupMenus.setOnMenuItemClickListener {
                when (it.itemId) {
                    R.id.editText -> {
                        val v = LayoutInflater.from(c).inflate(R.layout.activity_add_notes, null)
                        val name = v.findViewById<EditText>(R.id.bookName)
                        val number = v.findViewById<EditText>(R.id.desBook)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        ...
        val v = inflater.inflate(R.layout.card_list, parent, false)
